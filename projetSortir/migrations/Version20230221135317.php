 ...
 */
final class Version20230221135317 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participant DROP administrateur, CHANGE telephone telephone VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participant ADD administrateur TINYINT(1) NOT NULL, CHANGE telephone telephone INT NOT NULL');
