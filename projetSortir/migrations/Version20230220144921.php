 ...
 */
final class Version20230220144921 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie ADD organisateur_id INT DEFAULT NULL, ADD site_organisateur_id INT NOT NULL, ADD etat_id INT NOT NULL, ADD lieu_id INT NOT NULL, DROP etat');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie ADD etat VARCHAR(255) NOT NULL, DROP organisateur_id, DROP site_organisateur_id, DROP etat_id, DROP lieu_id');
